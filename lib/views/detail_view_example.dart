...
//   recipe_model.RecipeModel myRecipe;

//   DetialViewExample({Key? key, required this.myRecipe}) : super(key: key);
...
//                         builder: (context) =>
//                             VideoPlayerView(videoUrl: myRecipe.video))),
//                     child: const Icon(
//                       Icons.play_arrow,
//                       size: 70,
//                       color: Colors.white,
...
//                             BookMarkController();
//                         await bookMarkController.addBookMark(widget.myRecipe);
//                       }, //add bookmark
//                       child: const Padding(
//                         padding: EdgeInsets.all(12.0),
